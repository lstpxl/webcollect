...
// =============================================================================
function outhtml_script_user_toggle_ban() {

$str = <<<SCRIPTSTRING

function js_user_toggle_ban_query(user_id, modify) {

	var url = '/xhr/user_toggle_ban.php?user_id=' + user_id + '&modify=' + modify + '';
...
// =============================================================================
function outhtml_user_toggle_ban_result($param) {
	...
	$qr = mydb_queryarray("".
		" SELECT user.user_id, user.is_superadmin, user.is_ban ".
		" FROM user ".
	...
	$out .= '<!--';
	$out .= 'blockid=user_toggle_ban_div_id'.$param['user_id'].';';
	$out .= '-->';
	...
	if ($modify) {
		$onclick_insert = ' onclick="js_user_toggle_ban_query('.$param['user_id'].', \'y\'); return false; " ';
...
// =============================================================================
function outhtml_user_toggle_ban_div($param) {

	$out = '';
	
	$out .= '<div id="user_toggle_ban_div_id'.$param['user_id'].'">';
...
// =============================================================================
function try_update_user_toggle_ban(&$param) {
...
// =============================================================================
function jqfn_user_toggle_ban($param) {
...
if (!function_exists('localxhr')) {
	function localxhr($param) {
		jqfn_user_toggle_ban($param);
		return true;
	}
}


if (mb_strpos('_'.$_SERVER['SCRIPT_FILENAME'], '/xhr/user_toggle_ban.php') > 0) {
