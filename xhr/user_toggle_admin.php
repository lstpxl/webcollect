...
// =============================================================================
function outhtml_script_user_toggle_admin() {

$str = <<<SCRIPTSTRING

function js_user_toggle_admin_query(user_id, modify) {

	var url = '/xhr/user_toggle_admin.php?user_id=' + user_id + '&modify=' + modify + '';
...
// =============================================================================
function outhtml_user_toggle_admin_result($param) {
	...
	$qr = mydb_queryarray("".
		" SELECT user.user_id, user.is_superadmin, user.is_admin ".
		" FROM user ".
	...
	$out .= '<!--';
	$out .= 'blockid=user_toggle_admin_div_id'.$param['user_id'].';';
	$out .= '-->';
	...
	if ($qr[0]['is_admin'] == 'Y') {
		$str = 'администратор';
		$style = ' background-color: #b40d00; color: #ffffff; ';
	} else {
		$str = 'не админ.';
		$style = ' color: #808080; ';
	}
	...
	if ($modify) {
		$onclick_insert = ' onclick="js_user_toggle_admin_query('.$param['user_id'].', \'y\'); return false; " ';
...
// =============================================================================
function outhtml_user_toggle_admin_div($param) {

	$out = '';
	
	$out .= '<div id="user_toggle_admin_div_id'.$param['user_id'].'">';
...
// =============================================================================
function try_update_user_toggle_admin(&$param) {
...
// =============================================================================
function jqfn_user_toggle_admin($param) {
...
if (!function_exists('localxhr')) {
	function localxhr($param) {
		jqfn_user_toggle_admin($param);
		return true;
	}
}


if (mb_strpos('_'.$_SERVER['SCRIPT_FILENAME'], '/xhr/user_toggle_admin.php') > 0) {
