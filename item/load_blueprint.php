...
function outhtml_blueprint_instruction($param) {
	...
	$out = '';
		...
		$out .= '<div style=" margin-top: 10px; background-color: #66737b; padding: 20px; border-top: solid 4px #000000; ">';
			...
			$out .= '<p style=" margin-bottom: 6px; " >Формата файла JPEG.</p>';
			...
			$out .= '<p style=" margin-bottom: 6px; " ><img src="/images/blueprint_sample.png" /></p>';
...
// =============================================================================
function outhtml_item_load_blueprint($param) {
