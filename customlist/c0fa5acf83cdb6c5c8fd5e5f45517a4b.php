...
// =============================================================================
function outhtml_item_list_searchbar_customlist_c0fa5acf83cdb6c5c8fd5e5f45517a4b($param) {

	$out = '';

		$link = '/customlist/c0fa5acf83cdb6c5c8fd5e5f45517a4b.php';
		$out .= '<form method="GET" id="searchform" enctype="multipart/form-data" action="'.$link.'">';
			...
			$out .= '<input type="hidden" name="tcl" id="" value="3" />';
...
// =============================================================================
function outhtml_item_search_result_customlist_c0fa5acf83cdb6c5c8fd5e5f45517a4b($param) {
	...
	$param['extuser'] = '3';
	$param['search'] = 'browse';
	$GLOBALS['customlist'] = 'c0fa5acf83cdb6c5c8fd5e5f45517a4b';
	...
	*/
	...
	$out .= '<div id="searchbarenv" style=" ">';
		$out .= outhtml_item_list_searchbar_customlist_c0fa5acf83cdb6c5c8fd5e5f45517a4b($param);
...
// =============================================================================
function outhtml_customlist_c0fa5acf83cdb6c5c8fd5e5f45517a4b($param) {
	...
	$out .= '<div style=" padding-top: 20px; background-color: #f8f8f8; padding-left: 0px; color: #888888; line-height: 125%; " >';
		...
		$out .= '<div id="item_search_result_div" style=" width: 970px; ">';
			$out .= outhtml_item_search_result_customlist_c0fa5acf83cdb6c5c8fd5e5f45517a4b($param);
		$out .= '</div>';
